...
Revision ID: 0022_object_deletion_outbox
Revises: 0021_agent_event_timestamp
...
revision: str = "0022_object_deletion_outbox"
down_revision: str | Sequence[str] | None = "0021_agent_event_timestamp"
